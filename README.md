...
The script, when used on the appropriate dataset, was used to create three different graphs depicting:
...
Download dataset (https://github.com/user-attachments/files/17605824/coral_forecast.zip)
